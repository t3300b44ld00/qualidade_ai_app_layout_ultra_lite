...
block_cipher = None
a = Analysis(['app/main.py'], pathex=[], binaries=[], datas=[],
...
exe = EXE(pyz, a.scripts, [], exclude_binaries=True, name='QualidadeAI', debug=False,
          bootloader_ignore_signals=False, strip=False, upx=True, console=False)
coll = COLLECT(exe, a.binaries, a.zipfiles, a.datas, strip=False, upx=True, upx_exclude=[], name='QualidadeAI')
